...
if(count($paseos) > 0){
    ...
    echo "<tr><th>ID</th><th>Fecha</th><th>Hora inicio - Hora Fin</th><th>Precio total</th><th>Paseador</th><th>Perro</th><th>Estado</th><th>Acciones</th></tr>";
    ...
    foreach ($paseos as $pac) {
        ...
        foreach ($filtros as $f) {
            ...
            $paseador = str_ireplace($f, "<strong>" . substr($paseador, stripos($paseador, $f), strlen($f)) . "</strong>", $paseador);
        ...
        echo "<td><a href='modalPaseo.php?idPaseo=" . $pac->getId() . "&idPaseador=" . $pac->getPaseador_idPaseador()->getId() . "' class='abrir-modal' data-id='" . $pac->getId() . "' style='color: #4b0082;'><span class='fas fa-eye' title='Ver más información'></span></a></td>";
        echo "</td>";
        echo "</tr>";
    }
