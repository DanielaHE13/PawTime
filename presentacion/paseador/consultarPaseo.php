...
$paseo = new Paseo();
$paseos = $paseo -> consultarTodos($rol,$id);
?>
  	...
  	<h5 class="card-title" style="color: #4b0082;">Paseo</h5>
    	<table class="table class='table table-striped table-hover mt-3">
            ...
            <tr>
               ...
               <td>$<?php echo number_format($p->getPrecio_total(), 0, ',', '.'); ?></td>
               ...
               <td>            
               	    <a href="modalPaseo.php?idPaseo=<?php echo $p->getId(); ?>&idPaseador=<?php echo $id; ?>" class="abrir-modal" data-id="<?php echo $p->getId(); ?>" style="color: #4b0082;"><span class="fas fa-eye" title="Ver más información"></span></a>
					<a href="modalPerrito.php?idPerrito=<?php echo $p->getPerro_idPerro()->getId(); ?>" class="abrir-modal" data-id="<?php echo $p->getPerro_idPerro()->getId(); ?>" style="color: #4b0082;" title="Ver info del perrito">
